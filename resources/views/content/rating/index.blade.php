...
@section('title', 'View All Ratings')
    ...
    <section id="basic-examples">
        <div class="card">
            <div class="card-body">
                ...
                <div id="myGrid" class="aggrid ag-theme-material justify-content-between align-items-center"></div>
            </div>
        </div>
    </section>
...
@section('page-script')
    {{-- Page js files --}}
    <script src="{{ asset(mix('js/contents/rating.js')) }}"></script>
@endsection